<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="报名人群" prop="baomingrenqun">
          <el-input v-model="ruleForm.baomingrenqun" 
              placeholder="报名人群" clearable  :readonly="ro.baomingrenqun"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="报名人群" prop="baomingrenqun">
              <el-input v-model="ruleForm.baomingrenqun" 
                placeholder="报名人群" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shetuanmingcheng = true;
          ...
          if(o=='baomingrenqun'){
            this.ruleForm.baomingrenqun = obj[o];
	    this.ro.baomingrenqun = true;
            continue;
          }
          if(o=='huodongtupian'){
	...
	this.ruleForm.huodongxiangqing = this.ruleForm.huodongxiangqing.replace(reg,'../../../springboot12748/upload');
        } else {
          this.$message.error(data.msg);
        }
      });

<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="社团类型" prop="shetuanleixing">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="社团简介" prop="shetuanjianjie">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shetuanjianjie" label="社团简介" prop="shetuanjianjie">
                    <span v-html="ruleForm.shetuanjianjie"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>

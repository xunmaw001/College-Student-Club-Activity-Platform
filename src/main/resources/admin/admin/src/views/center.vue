  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='shezhang'"  label="姓名" prop="xingming">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='shezhang'"  label="身份证" prop="shenfenzheng">
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if( 'shezhang' ==this.flag && this.ruleForm.shenfenzheng&&(!checkIdCard(this.ruleForm.shenfenzheng))){

  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 250, 250, 0.57);borderRadius:10px">
        <h1 class="h1" style="color:rgba(81, 163, 81, 1);fontSize:28px;">大学生社团活动平台注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='shezhang'" class="input-group">
			   <div class="label">账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zhanghao" class="input" type="text" placeholder="账号">
			   </div>
			 </div> -->
			<el-form-item label="账号" class="input" v-if="tableName=='shezhang'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='shezhang'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<!-- <div v-if="tableName=='shezhang'" class="input-group">
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='shezhang'">
			...
			<el-form-item label="身份证" class="input" v-if="tableName=='shezhang'">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='shezhang'">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='shezhang'">
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if((!this.ruleForm.zhanghao) && `shezhang` == this.tableName){
      ...
      if(`shezhang` == this.tableName && this.ruleForm.shenfenzheng&&(!this.$validate.checkIdCard(this.ruleForm.shenfenzheng))){
      ...
      if(`shezhang` == this.tableName && this.ruleForm.youxiang&&(!this.$validate.isEmail(this.ruleForm.youxiang))){
